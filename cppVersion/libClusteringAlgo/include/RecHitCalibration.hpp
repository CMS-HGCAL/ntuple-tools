...
//
//  Copy of the python script RecHitCalibration.py:
//
...
public:
  ...
  inline double MIPperGeV(int layer,int thicknessIndex){
  ...
  inline double sigmaNoiseMeV(int layer,int thicknessIndex){
